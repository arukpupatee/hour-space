...
<html>
    ...
    <body class="space-body">
        ...
        <div class="container-fluid space-header space-image" style="background-image:url(../space4.jpg)">
        </div>
        <div class="container space-top">
            <div class="space-title clearfix">
                <div class="space-title-left col-md-8 col-sm-7 col-xs-12">
                    <h3>Quest - Connaisseur Cafe</h3>
                    ...
                    <div class="space-icon">
                        <span class="iconblock"><span class="icon icon-clock" aria-hidden="true"></span>6.00-22.00</span>
                        <span class="iconblock"><span class="icon icon-people" aria-hidden="true"></span>6-12 คน</span>
                    </div>
                </div>
                <div class="space-title-right col-md-4 col-sm-5 col-xs-12">
                    <div class="space-price-tag">
                        <div class="space-price"><span class="space-price-text">฿<span class="space-price-amount" data-value=300>300</span></span>/<span class="space-price-hour"></span>ชม.</div>
                    ...
                    <div class="space-right-box space-food">
                        <div>ได้รับ <span class="color-black">เครื่องดื่มมูลค่า 300 บาท</span></div>
                        <div class="small"><a class="no-decor underline">เลือกเครื่องดื่ม</a></div>
                        <div class="food-image" style="background-image:url('../food4.jpg')"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="space-detail col-md-8 col-sm-7 col-xs-12">
                    <div class="detail-sec row">
                        <div class="detail-fullline space-desc col-xs-12">
                            ที่นั่งประชุม คุยงาน หรือทำงาน สำหรับ 6-12 คน
                        </div>
                    </div>
                    <div class="detail-sec row">
                    ...
                    <div class="detail-sec row">
                        ...
                        <div class="detail-line col-md-8 col-xs-12">
                            Quest Connaisseur Cafe เหมือนโอเอซิสใจกลางเมือง เป็นร้านที่มีสไตล์การตกแต่งแนว Loft กับบริเวณภายในร้านที่กว้างขวางเพราะมีทั้งโซนอินดอร์และที่นั่งเอาท์ดอร์ซึ่งอยู่หลังร้าน
                        </div>
                    </div>
                    <div class="detail-sec row">
                        <div class="detail-heading col-md-4 col-xs-12">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3875.3891034394583!2d100.53063431407493!3d13.75539320091801!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e29eca5a3b5979%3A0x3d24d3c8ebf364a2!2sQuest+Connaisseur-Cafe-Bangkok!5e0!3m2!1sen!2sth!4v1494003414932" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                    ...
                    <div class="modal-body">
                        ...
                        <form class="space-modal-form clearfix" id="modalform">
                            ...
                            <div class="row gutter-15">
                                ...
                                <input type="hidden" name="space" value=4>
                            </div>
                        </form>
