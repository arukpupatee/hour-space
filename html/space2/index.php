        ...
        <div class="container space-top">
            <div class="space-title clearfix">
                <div class="space-title-left col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="space-icon">
                        <span class="iconblock"><span class="icon icon-clock" aria-hidden="true"></span>8.00-18.00</span>
                ...
                <div class="space-title-right col-md-4 col-sm-5 col-xs-12">
                    ...
                    <div class="space-right-box space-food">
                        ...
                        <div class="food-image" style="background-image:url('../food2.jpg')"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="container space-middle">
            <div class="space-detail col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="detail-sec row">
                        ...
                        <div class="detail-line col-md-8 col-xs-12">
                            Factory Cafe & Brew Bar เป็นคาเฟ่ สุดพิเศษสำหรับคนชอบกาแฟ  เปิดบริการอยู่ในกรุงเทพ ทางร้านจะเสิร์ฟเฉพาะกาแฟที่ได้ผลผลิตตามแต่ละฤดูกาล  และ คาเฟ่นี้ยังชอบแบ่งปันเรื่องราวในเรื่องสถานที่ที่มาและขั้นตอนกรรมวิธีของเมล็ดกาแฟ จนกลายมาเป็น รสชาติในแก้วกาแฟ
                        </div>
                    </div>
                    <div class="detail-sec row">
                        <div class="detail-heading col-md-4 col-xs-12">
                    ...
                    <div class="detail-sec row">
                        ...
                        <div class="col-md-8 col-xs-12">
                            Phayathai Road, Bangkok ( BTS Phayathai Station, Exit No. 4)
                            <br>Car park: Wannasorn Tower                        
                        </div>
                    </div>
            </div>
        </div>
