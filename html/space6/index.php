...
<html>
    ...
    <body class="space-body">
        ...
        <div class="container-fluid space-header space-image" style="background-image:url(../space6.jpg)">
        </div>
            ...
            <div class="space-title clearfix">
                <div class="space-title-left col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="space-icon">
                        ...
                        <span class="iconblock"><span class="icon icon-people" aria-hidden="true"></span>4-6 คน</span>
                    </div>
                </div>
                <div class="space-title-right col-md-4 col-sm-5 col-xs-12">
                    <div class="space-price-tag">
                        <div class="space-price"><span class="space-price-text">฿<span class="space-price-amount" data-value=200>200</span></span>/<span class="space-price-hour"></span>ชม.</div>
                    ...
                    <div class="space-right-box space-food">
                        <div>ได้รับ <span class="color-black">เครื่องดื่มมูลค่า 200 บาท</span></div>
                        <div class="small"><a class="no-decor underline">เลือกเครื่องดื่ม</a></div>
                        <div class="food-image" style="background-image:url('../food6.jpg')"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="space-detail col-md-8 col-sm-7 col-xs-12">
                    <div class="detail-sec row">
                        <div class="detail-fullline space-desc col-xs-12">
                            ที่นั่งประชุม คุยงาน หรือทำงาน สำหรับ 4-6 คน
                        </div>
                    </div>
                    <div class="detail-sec row">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="space-modal-form clearfix" id="modalform">
                            ...
                            <div class="row gutter-15">
                                ...
                                <input type="hidden" name="space" value=6>
                            </div>
                        </form>
